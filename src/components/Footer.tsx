...
export default function Footer() {
    return (
        <>
            ...
            >
                <div className="flex flex-col gap-6">
                    ...
                    <p className="text-white text-lg max-md:text-center">
                        Crowdfund and support your favorite streamers via cryptocurrency.
                    </p>
                </div>
            ...
            <div className="my-12">
                <p className="text-center text-gr text-lg">
                    &copy; 2024 - Made by Nick Mura Team & Trident Ventures
                </p>
            </div>
