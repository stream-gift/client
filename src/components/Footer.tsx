...
export default function Footer() {
    return (
        <>
        <footer className="
            mx-24 border-t-[1px] border-opacity-50 border-t-gr p-8 flex items-center justify-between pr-44
        ...
        >
            <div className="flex flex-col gap-6">
                ...
                <p className="text-white text-lg max-md:text-center">Crowdfund and support your favorite streamers via cryptocurrency.</p>
            </div>
        ...
        <div className="my-12">
            <p className="text-center text-gr text-lg">&copy; 2024 - Made by Nick Mura Team & Trident Ventures</p>
        </div>
